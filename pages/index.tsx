  ...
  return (
    <ContentContainer>
      <About>
        ...
        <p>Привет, меня зовут Евгений, мне {correctedYears} лет. Занимаюсь разработкой два года с использованием всех современных технологий. На этом сайте есть список моих работ, а также способы связаться со мной.</p>
